...
//arm-none-eabi-objcopy -O binary DISC_TFT.elf DISC_TFT.bin
//st-flash --reset write DISC_TFT_ROS.bin 0x8000000
...
char hello[] = "Hello this is hasib!";
...
int main(void)
{
  ...
  //__HAL_UART_ENABLE_IT(&huart1,IT_RXNE)
  //HAL_UART_Receive_IT(&huart1, (uint8_t*)pData,10);
  //MX_USART1_UART_Init();
...
#endif
	 //HAL_Delay(1000);
	 //HAL_UART_Transmit_DMA(&huart1, (uint8_t*)pData,10);
	  //HAL_UART_Receive(&huart1, (uint8_t*)pData,10,1000);
	 //memset(time_ms_str,0,10);
	 //itoa(time_ms,time_ms_str,10);
/*
...
*/
	  ...
	  dt=hd.read();
  	  ...
  	  itoa(time_ms,dlen,10);
  	  BSP_LCD_DisplayStringAtLine(2,(uint8_t*)time_ms_str);
 	  //BSP_LCD_DrawHLine(50, 50, 50);
 	  HAL_Delay(100);
 	  */
